package org.kylin.zhang.EmailUtil;
...
import org.kylin.zhang.EmailUtil.bean.EmailBean;
import scala.Tuple2;
...
public class EmailUtil implements Serializable{
    ...
    * */
    ...
    public static void main (String [] args ) throws Exception {
        ...
        List<EmailBean> emailBeanList = EmailReader.getAllEmailBeanFromFiles(emailPathName) ;
